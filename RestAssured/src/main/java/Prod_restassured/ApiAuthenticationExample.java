...
public class ApiAuthenticationExample {
    public static void main(String[] args) 
    {
	  ...
	  RestAssured.baseURI = "https://web.byui.edu";
	  ...
	  String requestBody = "username=EPS&password=tLgYMrFcivj9wFHAPqsr7NKYU93c37AH";
	  ...
	  String fileName = "Prod_Cookie.txt"; try (FileWriter fileWriter = new FileWriter(fileName)) {
	  fileWriter.write(sessionCookie.toString());
	  System.out.println("Prod ATI Cookie Saved to: " + fileName); } catch
